    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="shrink-0">
                    <a href="{{ route('home') }}">
                        <span class="text-lg font-bold text-stone-300"><img src="https://cdn-icons-png.flaticon.com/512/3271/3271154.png" alt="logo" class="w-10"></span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                <a href="{{ route('login') }}"
                    class="text-gray-300 hover:text-gray-100 transition px-4 py-2 rounded-full text-sm font-medium mr-4">
                    Masuk
                </a>
                <a href="{{ route('register') }}"
                    class="bg-white text-black hover:bg-gray-300 transition px-4 py-2 rounded-full text-sm font-medium">
                    Daftar
                </a>
                @endauth
            </div>
